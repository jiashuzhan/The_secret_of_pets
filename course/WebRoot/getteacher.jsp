...
<jsp:useBean id="cla" scope="page" class="tzc.bean.teacher"/>
...
title=rs.getString("title");
 ...
 <td><a href="/course/updateTeacher.jsp?id=<%=id %>">更新</a></td>
 </tr>
 <%} %>
        </nav>
       </div>
