...
<jsp:useBean id="cla" scope="page" class="tzc.bean.student"/>
<body bgcolor="#F5F5DC" TEXT="#4682B4" link="#4682B4">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div>
      <%
String id="",name="",password="",jiguan="",sex="",dep="";
%>
<div align="center">
<p>
<font color="#4682B4" size="+3" face="宋体">所有学生</font></p>
<p align="left"><font color="#4682B4" SIZE="+1" face="宋体">
<a href="/course/AddClass.jsp">新增学生</a></font></p>
...
name=rs.getString("name");
 ...
 <td><a href="/course/updateStudent.jsp?id=<%=id %>">更新</a></td>
 </tr>
 <%} %>
        </nav>
       </div>
